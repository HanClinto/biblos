...
chunk_size = 1000
chunk_overlap = 0
#verse_splitter = CharacterTextSplitter.from_huggingface_tokenizer(
...
#print(f' Embedding model max tokens: {embedding_function.max_tokens}')

# Create Chroma database
print(f"Initializing db and creating embeddings to {output_dir}...")
